...
## Generated with 'brightbox' on Tue Sep 28 15:56:16 +0800 2010
gem 'brightbox', '>=2.3.7'
...
set :domain, "11846286-001.vm.brightbox.net"

## List of servers
server "11846286-001.vm.brightbox.net", :app, :web, :db, :primary => true
